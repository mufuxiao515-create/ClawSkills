...
# DataTable 资产路径映射
DT_ASSET_PATHS = {
    0: "/Game/SMG/Configs/DataTables/AISkills/DT_AI_Skills_Part0",
    1: "/Game/SMG/Configs/DataTables/AISkills/DT_AI_Skills_Part1",
    2: "/Game/SMG/Configs/DataTables/AISkills/DT_AI_Skills_Part2",
    "rogue": "/Game/SMG/Configs/DataTables/AISkills/DT_AI_Skills_Rogue",
    "main": "/Game/SMG/Configs/DataTables/AISkills/DT_AI_Skills",
}
...
def import_part(all_skills, part_number):
    """导入指定 Part 的技能数据到 DataTable"""
    dt_path = DT_ASSET_PATHS.get(part_number)
    if not dt_path:
...
def main():
    ...
    # 默认路径回退
    if not json_path:
        project_root = os.environ.get("ProjectDir", r"C:\zongjunli_ZONGJUNLI-PC2_313\SMG")
        json_path = os.path.join(project_root, "Content", "SMG", "Configs", "NonAsset", "Json", "Json_AI_Skills.json")
